...
import SingleParticipant from './SingleParticpant';
                ...
                <View style={{
                    ...
                    <DataTable>
                        ...
                        >
                            ...
                            <DataTable.Title textStyle={{ color: textColor, }}>Time out</DataTable.Title>
                        </DataTable.Header>
                            ...
                            props.participants?.length > 0 ? props.participants.map((i, index) => (
                                <Pressable key={index} onPress={() => props.handleSelectuserrow(i)}>
                                    ...
                                    >
                                            ...
                                            <DataTable.Cell style={{ flex: 1 }}>
                                                <Text style={{ color: textColor }}>{new Date(i.time_out).toLocaleString()}</Text>
                                            </DataTable.Cell>
                                    </DataTable.Row>
                                </Pressable>
                            )) :
